...
class ShortestJobFirstScheduler : public QObject {
    Q_OBJECT

public:
    explicit ShortestJobFirstScheduler(QObject *parent = nullptr);
...
private:
    ...
    // Método para calcular el siguiente proceso a ejecutar basado en tiempo de ejecución
